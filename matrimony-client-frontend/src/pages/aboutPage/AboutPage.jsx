          ...
          <div className="flex flex-wrap -mx-6 items-start">
            ...
            <div className="w-full lg:w-1/2 px-6">
              <div className="lg:pl-10">
                <h1 className="text-5xl lg:text-7xl font-bold text-[#5c2a9d] mb-4 uppercase tracking-wide break-words">Built on Faith. Bound by Love.</h1>
                <h3 className="text-4xl font-bold text-gray-900 mb-6">Our Sacred Covenant</h3>
