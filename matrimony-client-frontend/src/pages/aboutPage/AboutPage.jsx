...
const AboutPage = () => {
  return (
    <div className="min-h-screen bg-[#f8f9fa]" style={{ fontFamily: "'Outfit', 'Inter', sans-serif" }}>
        ...
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-10">
              <div>
                <h2 className="text-2xl font-bold text-gray-900 mb-4" style={{ fontFamily: '"Playfair Display", serif' }}>One Faith, Many Traditions</h2>
              ...
              <div>
                <h2 className="text-2xl font-bold text-gray-900 mb-4" style={{ fontFamily: '"Playfair Display", serif' }}>Our Vision</h2>
                <p className="text-gray-600 leading-snug">
