...
//                 <li style={{ padding: "0px 15px", display: "flex", alignItems: "center" }}>
//                   <Link
//                     to="/user/events-page"
//                     onClick={handleLinkClick}
//                     className="nav-highlight-events"
//                   >
//                     <FaCalendarAlt /> &nbsp; EVENT
...
//                     <li><Link className="dropdown-item" to="/report-issue" onClick={handleLinkClick}>Report an Issue</Link></li>
//                   </ul>
//                 </li>
